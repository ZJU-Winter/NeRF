    ...
    for i in trange(start, N_iters):
        ...
        if i % args.i_print == 0:
            ...
            if i % args.i_img == 0:
                ...
                imageio.imwrite(os.path.join(testimgdir, '{:06d}.png'.format(i)), utils.to8b(rgb))
                imageio.imwrite(os.path.join(testimgdir, 'target_{:06d}.png'.format(i)), utils.to8b(target))
